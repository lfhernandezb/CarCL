...
-(id)fromXml:(NSString *)xmlString withObjectName:(NSString *)objectName{
	...
	NSObject *obj = [[[NSClassFromString(objectName) alloc] init] autorelease];
	...
	// const char *objectName = class_getName([obj class]);
	NSString *objectNameStr = [NSString stringWithCString:[objectName UTF8String] encoding:NSASCIIStringEncoding];
